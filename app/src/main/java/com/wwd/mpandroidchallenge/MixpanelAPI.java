...
/**
 * Used from https://gist.github.com/mixpanel-bot/37465f1c9203aace918b
 */
...
public class MixpanelAPI {
    // returns a default instance of MixpanelAPI to implement singleton
    // in other words only one instance of MixpanelAPI object exists in the application
    private static MixpanelAPI mixpanelAPI;

    public static MixpanelAPI getDefaultInstance() {
        if (mixpanelAPI == null) {
